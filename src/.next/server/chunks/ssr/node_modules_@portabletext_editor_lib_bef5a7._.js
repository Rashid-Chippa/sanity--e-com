...
const getSelectionText = ({ context })=>{
    ...
    if (!block) return "";
    const startOfBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$reverse$2d$selection$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBlockStartPoint"])({
        node: block,
        path: [
            {
                _key: block._key
...
//# sourceMappingURL=node_modules_%40portabletext_editor_lib_bef5a7._.js.map